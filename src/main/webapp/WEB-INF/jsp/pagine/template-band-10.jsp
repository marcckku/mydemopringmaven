<%-- 
    Document   : template-band-10
    Created on : 25-gen-2018, 15.34.20
    Author     : Marco
...
<html lang="en">
    ...
    <body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="50">
            ...
            <div class="row">
                <div class="col-sm-4">
                    ...
                    <a href="#demo" data-toggle="collapse">
                        <img src="${pageContext.request.contextPath}/resources/theme1/images/bandmember.jpg" 
                ...
                <div class="col-sm-4">
                    ...
                    <a href="#demo2" data-toggle="collapse">
                        <img src="<c:url value="/resources/theme1/images/bandmember.jpg" />" 
                             class="img-circle person" alt="Random Name" width="255" height="255"> 
                        <!--
                         <img src="$ { pageContext.request.contextPath}/resources/theme1/bandmember.jpg" 
                             class="img-circle person" alt="Random Name" width="255" height="255">
                        -->
                    </a>
        ...
        <div id="tour" class="bg-1">
            <div class="container">
                ...
                <div class="row text-center">
                    <div class="col-sm-4">
                        <div class="thumbnail">
                            <img src="${pageContext.request.contextPath}/resources/theme1/images/paris.jpg" alt="Paris" width="400" height="300">
                    ...
                    <div class="col-sm-4">
                        <div class="thumbnail">
                            <img src="${pageContext.request.contextPath}/resources/theme1/images/newyork.jpg" alt="New York" width="400" height="300">
                    ...
                    <div class="col-sm-4">
                        <div class="thumbnail">
                            <img src="${pageContext.request.contextPath}/resources/theme1/images/sanfran.jpg" alt="San Francisco" width="400" height="300">
        ...
        <div class="map-info"><h1>Maurizio Tarchini</h1>Lorem ipsum dolor, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</div>
        ...
        <script>
            ...
            var mioLogo = new google.maps.MarkerImage('cantinflas.jpg',
